...
import { Vault } from "../staking/vault_state";
...
let farmProgram = anchor.workspace
  .SingleFarming as anchor.Program<SingleFarming>;
let stakeProgram = anchor.workspace.Staking as anchor.Program<Staking>;
...
function getPendingReward(
  farmProgram: anchor.Program<SingleFarming>,
  owner: Pubkey,
  user: Pubkey,
...
async function getxMerVirtualPrice(stakeProgram: anchor.Program<Staking>) {
